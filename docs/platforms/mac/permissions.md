...
- Same path: run the app from a fixed location (for AeonSage, `dist/AeonSage.app`).
...
```bash
sudo tccutil reset Accessibility com.aeonsage.mac
sudo tccutil reset ScreenCapture com.aeonsage.mac
