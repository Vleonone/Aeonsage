...
- Install via CLI: `aeonsage plugins install @aeonsage/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `aeonsage plugins install ./extensions/zalo`
   - From npm (if published): `aeonsage plugins install @aeonsage/zalo`
...
- Approve via:
  - `aeonsage pairing list zalo`
  - `aeonsage pairing approve zalo <CODE>`
...
- Example: `aeonsage message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `aeonsage channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `aeonsage logs --follow`
