...
read_when:
  - You want AeonSage to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables AeonSage to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`aeonsage onboard`) and `aeonsage channels add` list optional channel plugins.
...
```bash
aeonsage plugins install @aeonsage/nostr
```

Use a local checkout (dev workflows):

```bash
aeonsage plugins install --link <path-to-aeonsage>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "aeonsage",
        "displayName": "AeonSage",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "aeonsage@example.com",
        "lud16": "aeonsage@example.com"
      }
    }
  }
}
