...
Deploy AeonSage on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/aeonsage-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/aeonsage` — Control UI

## What you get

- Hosted AeonSage Gateway + Control UI
...
- `AEONSAGE_STATE_DIR=/data/.aeonsage` (recommended)
- `AEONSAGE_WORKSPACE_DIR=/data/workspace` (recommended)
- `AEONSAGE_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your AeonSage state + workspace so you can migrate to another host without losing config or memory.
