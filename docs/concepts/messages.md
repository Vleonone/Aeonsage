...
This page ties together how AeonSage handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. AeonSage keeps a
...
AeonSage separates the **prompt body** from the **command body**:
...
AeonSage can expose or hide model reasoning:
