...
- Generated Swift models: `apps/macos/Sources/AeonSageProtocol/GatewayModels.swift`

## Current pipeline

- `pnpm protocol:gen`
  - writes JSON Schema (draft�?7) to `dist/protocol.schema.json`
...
- https://raw.githubusercontent.com/aeonsage/aeonsage/main/dist/protocol.schema.json
