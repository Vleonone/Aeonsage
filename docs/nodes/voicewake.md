...
AeonSage treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.aeonsage/settings/voicewake.json`

Shape:

```json
{ "triggers": ["aeonsage", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
