...
## What works
- **Media understanding (audio)**: If audio understanding is enabled (or autoâ€‘detected), AeonSage:
...
AeonSage auto-detects in this order and stops at the first working option:
