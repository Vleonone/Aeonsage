---
summary: "Use MiniMax M2.1 in AeonSage"
read_when:
  - You want MiniMax models in AeonSage
...
Configure manually via `aeonsage.json`:
...
- Use `aeonsage models list` and `aeonsage models set minimax/MiniMax-M2.1` to switch.
...
- Running `aeonsage configure` and selecting **MiniMax M2.1**, or
