---
summary: "Use Qwen OAuth (free tier) in AeonSage"
read_when:
  - You want to use Qwen with AeonSage
...
```bash
aeonsage models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, AeonSage will sync credentials
