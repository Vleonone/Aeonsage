...
export function resolveTtsConfig(cfg: AeonSageConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.AEONSAGE_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: AeonSageConfig): string | undefined {
